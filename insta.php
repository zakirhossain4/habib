...
$sqli="INSERT INTO instagram(type, day, link, location, mobile, budget) VALUES ('$type', '$day', '$link', '$location', '$mobile', '$budget')";
            ...
            <div class="container">
                <section class="page-section" id="contact">
                    <div class="container">
                     ...
                     <div class="row ">
                        <div class="h11">
                            <h2 class="section-heading text-uppercase">Instagram Video Boost</h2>
                        </div>
                        <div class="col-lg-6">
                        <img src="assets/img/IMG-20230322-WA0031.jpg" alt=""  srcset="">
                        </div>
                        <div class="col-lg-6">
                       <div>
                        <h2>INSTAGRAM BOOSTING SERVICES</h2>
